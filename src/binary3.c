 ...
 * file are on lines 56-60; I added 
 * a third component for clarity; it takes
 * made ic files and turns into input for 
 * Gadget2 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main()
{
  ...
  printf("Enter number of halo, disk, bulge particles (comma separated,in said order) >");
  scanf("%d,%d,%d",&header1.npart[1],&header1.npart[2],&header1.npart[3]);

  printf("Enter mass of halo, disk,bulge particles (comma separated, in said order) >");
  scanf("%lf,%lf,%lf",&header1.mass[1],&header1.mass[2],&header1.mass[3]);
